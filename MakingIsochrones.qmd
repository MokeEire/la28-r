...
ggplot(nhgis_la_shp_subset)+
  ...
  scale_fill_continuous(breaks = scales::breaks_pretty(), labels = scales::comma, type = "viridis",
                        guide = guide_colorbar(nbin=20))+
  theme_void()

ggplot2::cut_interval(nhgis_la_shp_subset$POPULATION, 100000)
```
